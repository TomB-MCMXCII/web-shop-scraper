...
using WebShopScraper.Api.Services;

namespace WebShopScraper.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<WebShopScraperDbContext>(options => options.UseSqlServer(Configuration.GetConnectionString("azure")));
